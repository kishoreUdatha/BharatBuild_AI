...
# FREE users can: generate projects (limited to 3 files preview), run code
# Full project, documents, and downloads require Premium plan upgrade
FREE_TIER_FEATURES = {
    "agentic_mode": False,
    ...
    # Plan-based features
    "project_generation": True,  # ALLOWED - but limited to 3 files preview
    "code_preview": True,  # Can preview code structure
