...
class APIServiceGenerator:
    ...
    def _generate_interfaces(self) -> str:
        ...
        lines.extend([
            ...
            " * IMPORTANT: Use these exact property names when consuming paginated APIs",
            " */",
            "export interface PageResponse<T> {",
            "  content: T[];           // Array of items (NOT 'data' or 'items')",
            "  totalElements: number;  // Total count (NOT 'total')",
            "  totalPages: number;     // Total pages",
            "  number: number;         // Current page, 0-indexed (NOT 'page')",
