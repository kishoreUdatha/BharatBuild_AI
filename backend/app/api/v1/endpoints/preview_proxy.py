    ...
    if IS_REMOTE_DOCKER:
        ...
        try:
            ...
            if not containers:
                ...
                # Use frontend if found, otherwise fallback
                if frontend_container:
