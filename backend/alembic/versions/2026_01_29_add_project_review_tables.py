...
# Was down_revision = None, which declares this a second ROOT of the migration
# graph and therefore an independent head. Alembic allows exactly one base per
# linear history; chain it onto the lab migrations instead.
down_revision = 'add_lab_reports'
branch_labels = None
depends_on = None
