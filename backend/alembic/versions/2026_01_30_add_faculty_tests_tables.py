...
# Was down_revision = None (see the note in the project-review migration);
# chained here so the campus-portal migrations form one linear history.
down_revision = 'add_project_reviews'
branch_labels = None
depends_on = None
