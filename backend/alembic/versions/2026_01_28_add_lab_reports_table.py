...
# Was pointing at the FILENAME of the previous migration rather than its
# revision id. Alembic resolves by revision id, so this raised
# "Can't locate revision identified by '2026_01_28_add_lab_assistance_tables'"
# -- this migration has never run successfully anywhere.
down_revision = 'lab_assistance_001'
branch_labels = None
depends_on = None
