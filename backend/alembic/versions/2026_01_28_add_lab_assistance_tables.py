...
# Rechained onto the current master head. This branched off campus_drive_002,
# but master carried on from that same revision through 97e7b900b9dc ->
# add_owner_name_coupons -> add_subscription_reminder. Keeping the old parent
# would leave Alembic with two heads, and `upgrade head` fails outright with
# "Multiple head revisions are present" -- which, because migrations run at
# container startup, means the backend never boots.
