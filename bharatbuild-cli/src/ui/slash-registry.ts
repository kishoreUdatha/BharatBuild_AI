...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "permissions", description: "Show the per-tool permission rules in force", surfaces: ["tui"] },
  { name: "thinking", args: "[level]", description: "Extended thinking: off|low|medium|high", surfaces: ["tui"] },
  { name: "glyphs", args: "[set]", description: "Switch marker glyphs (unicode|claude|ascii)", surfaces: ["tui"] },
